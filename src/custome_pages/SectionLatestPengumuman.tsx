...
//
export interface SectionLatestPengumumanProps {
  className?: string;
  postCardName?: "card3";
}

const SectionLatestPengumuman: FC<SectionLatestPengumumanProps> = ({
  postCardName = "card3",
...
export default SectionLatestPengumuman;
